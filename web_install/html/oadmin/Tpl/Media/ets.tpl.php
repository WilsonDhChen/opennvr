    ...
    <script>
        function record_delete(id) {
            dialog.confirm("确定删除记录？",function () {
                $.when($.post("__URL__/ets_delete", {id:id}))
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <div class="form-container clearfix">
                <a href="__URL__/ets_info" class="btn btn-success btn-insert pull-right">新增</a>
            </div>
                    ...
                    <tbody>
                        <volist name="lists" id="vo">
                            <tr>
                                ...
                                <td align="right">
                                    <a href="__URL__/ets_info/id/{$vo.id}" class="btn btn-xs btn-success glyphicon glyphicon-ok"  title="点击修改"></a>
