...
.oaui-contextmenu-icon-config-tonavi{background-position:-84px 0;}
</style>
{:W('jQuery')}
{:W('Dialog')}
{:W('Ztree')}
...
$(function(){
	...
	<?php if(power('tonavi')):?>
	function createToNavi(id){
		dialog.frame('__URL__/tonavi/id/'+id,'生成栏目',true);
	}
	<?php endif;?>
...
$(function(){
 ...
 $('#submit').click(function(){
	...
	if(config_id == '0'){
		post_url = '__APP__/config/common_add_post';
	}else{
		post_url = '__APP__/config/common_edit_post';
	}
        ...
        <div class="tree-details f-r">
       	  <div class="container">
			    ...
			    <tr>
			      ...
			      <td><span id="config_parent">常用配置(2)</span><input type="hidden" name="parent_id" value="2" /><input type="hidden" name="config_id" value="0" /></td>
			    </tr>
                <?php if(power('identifier')):?>
