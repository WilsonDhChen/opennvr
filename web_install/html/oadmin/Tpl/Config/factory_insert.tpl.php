	...
	<div class="oaui-form">
		...
		<table cellpadding="0" cellspacing="0" border="0" width="100%">
			<tr>
                ...
                <td><input type="text" class="oaui-input-text" value="" name="name"  /></td>
            </tr>        
            <tr>
                <td width="20%" align="right"><strong>缩写</strong>：</td>
                <td><input type="text" class="oaui-input-text" value="" name="py"  /></td>
            </tr>
            <tr>
                <td width="20%" align="right"><strong>排序</strong>：</td>
                <td><input type="text" class="oaui-input-text" value="0" name="sort"  /></td>
            </tr>
        </table>
        </form>
	</div>	
