...
INSERT INTO `config_global_keyvalue` VALUES ('device_name','unicom','设备名字',14),('mode','PLATFORM','工作模式',15),('app','gb28181','Application           ',16),('domain','ln.jc.lncwkj.com',NULL,17);
...
) ENGINE=InnoDB AUTO_INCREMENT=87 DEFAULT CHARSET=utf8 COMMENT='moa系统员工登录日志';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2019-05-21 21:22:48
